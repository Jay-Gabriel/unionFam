...
export default function OnboardingPage() {
  ...
  return (
    <div className="legacy-calm-page fixed inset-0 overflow-y-auto bg-calm-deep-moss flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-white rounded-3xl p-8 border border-slate-200 shadow-xl space-y-6 my-auto">
